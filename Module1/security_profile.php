...
<body>
    ...
    <div class="container" style="text-align: center; padding: 70px;">
          <p>Welcome, <?php echo $user['full_name']; ?></p><br>
    <p>Username: <?php echo $user['username']; ?></p><br>

    <button class="update" type="button" name="update" onclick="window.location.href='security_profile_edit.php?id=<?php echo $user['user_id']; ?>'">Update</button>
    
    <a href="security_delete.php?id=<?php echo $user['user_id']; ?>" 
       onclick="return confirm('Are you sure you want to delete this user?')" class="delete">Delete</a>
    </div>
</body>
</html>
